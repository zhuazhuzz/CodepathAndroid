...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.button.setOnClickListener { selectNextFood() }
    ...
    private fun selectNextFood() {
        ...
        val apiKey = "d1b7cc6f9e7e4275810de69f02b18b89"
        params["limit"] = "5"
        params["page"] = "0"
        ...
        var randEle = idArr[(idArr.indices).random()].toString()

        val url = client["https://api.spoonacular.com/food/ingredients/$randEle/information?apiKey=$apiKey&amount=1", params, object :
            JsonHttpResponseHandler() {
            override fun onSuccess(statusCode: Int, headers: Headers, json: JSON) {
                val img: String = json.jsonObject.get("image").toString()
                ...
                Glide.with(this@MainActivity)
                    .load("https://spoonacular.com/cdn/ingredients_250x250/$img")
                    .into(binding.rngImage)

                binding.name.setText(name)
                binding.aisle.setText("In aisle: "+aisle)
                binding.special.setText("Consistency/Texture: "+texture)
